...
[
    "ghostbrhs_Main_TFARTransmitRange",
    "SLIDER",
...
[
    "ghostbrhs_Main_TFARTerrainInterference",
    "SLIDER",
...
// ghostbrhs_Main_DynamicSim
[
    "ghostbrhs_Main_DynamicSim",
    "CHECKBOX",
    ["ghostbrhs Dynamic Sim", "Simple check for Dynamic Sim enabled. If not enabled it will enable it to default ghostbrhs Values. "],
    COMPONENT_NAME,
    false,
    true,
    {

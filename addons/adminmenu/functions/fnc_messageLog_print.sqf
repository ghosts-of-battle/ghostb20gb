...
/* ----------------------------------------------------------------------------
Internal Function: ghostbrhs_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call ghostbrhs_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_ghostbrhs_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[ghostbrhs Adminmenu] Printed entry: %1%2",
